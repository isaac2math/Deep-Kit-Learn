...
setup(
    name="DKL",  # name of pypi package
    version=get_version(),  # version of pypi package
    python_requires=">=3.7,<=3.11",
    license='GPL-3.0',
    description='DeepKit Learn',
    long_description=README,
    long_description_content_type="text/markdown",
    url="https://github.com/ultralytics/ultralytics",
    project_urls={
        'Bug Reports': 'https://github.com/isaac2math/Deep-Kit-Learn/issues',
        'Source': 'https://github.com/isaac2math/Deep-Kit-Learn'},
    author="Ning Xu",
    author_email='xuningandy@gmail.com',
